...
window.AbilitiesEncyclopedia = {
    ...
    abilities: {
        ...
        'Veterano': {
            ...
            rarity: 'Leggendaria',
            type: 'Positiva',
            description: 'Nelle ultime 5 occasioni (26-30), ottiene +1.5 al modificatore',
            effect: '+1.5 mod nelle occasioni dalla 26 alla 30',
            mechanics: 'Durante le ultime 5 occasioni della partita (dalla 26 alla 30), il giocatore aggiunge +1.5 al suo modificatore',
            activation: '100% (ultime 5 occasioni)',
            example: 'Occasione 27 → Veterano attivo → +1.5 mod!',
            phase: 'Tutte le fasi (occasioni 26-30)',
        ...
        'Veterano': {
            ...
            rarity: 'Leggendaria',
            type: 'Positiva',
            description: 'Nelle ultime 5 occasioni della partita (dal 26 al 30), il giocatore aggiunge +1.5 al suo modificatore',
            effect: '+1.5 nelle ultime 5 occasioni',
            mechanics: 'Quando la partita entra nelle ultime 5 occasioni (tipicamente occasioni 26-30), questo giocatore esperto riceve +1.5 al modificatore',
            activation: '100% (ultime 5 occasioni)',
            example: 'Occasione 27/30 → Veterano attivo → +1.5 mod!',
            phase: 'Tutte le fasi',
            synergy: ['Freddezza', 'Forma Smagliante']
        },
        ...
        "Polmoni d'Acciaio": {
            ...
            rarity: 'Rara',
            type: 'Positiva',
            description: 'Nelle ultime 10 occasioni della partita (21-30), il modificatore aumenta di +2.0',
            ...
            example: 'Occasione 21/30 → Polmoni attivi → +2 mod!',
