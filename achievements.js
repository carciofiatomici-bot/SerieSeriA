                ...
                <div class="p-4 bg-gradient-to-r from-amber-600 to-yellow-500 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="text-white">
                            <span class="text-2xl font-bold" id="total-points">0</span>
                            <span class="text-sm opacity-80">punti</span>
                        </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 mt-1">
                            ...
                            <span class="text-xs text-amber-400">+${achievement.points} pts</span>
                        </div>
                    </div>
                    ${unlocked ? `
                        <div class="text-center">
