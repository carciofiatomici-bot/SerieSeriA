...
window.CoppaMain = {
    ...
    async simulateMatch(roundIndex, matchIndex, legType) {
        ...
        if (window.PlayerExp) {
            ...
            const matchEvents = result.matchEvents || [];
        ...
        if (window.MatchHistory && result.resultString) {
            ...
            if (window.FeatureFlags?.isEnabled('playerForm') && window.GestioneSquadreUtils?.updatePlayerFormAfterMatch) {
                ...
                await window.GestioneSquadreUtils.updatePlayerFormAfterMatch(match.homeTeam.teamId, homeTeamData, homeResult, homeFormStats);
                await window.GestioneSquadreUtils.updatePlayerFormAfterMatch(match.awayTeam.teamId, awayTeamData, awayResult, awayFormStats);
            }
